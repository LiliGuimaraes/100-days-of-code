...
function myFunction2() {
    // Dentro do escopo de uma função as variáveis podem ser usadas dentro de uma outra função
    var number1 = 10;
    var number2 = 20;
    var sum = function sum() {
        return "O returno da função 'sum' dentro de myFunction() é: " + number1 + " " + number2;
    };
