...
(function() { 
    ...
    */
    ...
    - É PRA ISSO QUE SERVE pegar o valor de uma função e passar como valor de uma propriedade do objeto
    */
    ...
    */
    ...
    function calculator1(op){
        return !!operation[op] ? false : function(a,b){
            return (isNaN(a) && isNaN(b)) ? false : operation[op](a,b)
        }
    }
    ...
    - o operador, o primeiro número e o segundo número. 
    O retorno da função deve ser a frase:
    'A operação [NUMBER1] [OPERATOR] [NUMBER2] =';
    Essa função mostrará a mensagem da operação que criaremos mais abaixo.
    */
    
function showOperationMessage(op, number1, number2){
    return "A operação " + number1 + " " + number2 + " " + ' = '

}
showOperationMessage("*",12,56)
    /*
